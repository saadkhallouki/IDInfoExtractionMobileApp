...
public class MainActivity extends AppCompatActivity {
    ...
    private void updateUIWithIDCardInfo(JSONObject idCardInfo) throws Exception {
        ...
        String firstName = idCardInfo.getString("first_name");
        String lastName = idCardInfo.getString("last_name");
        String dateOfBirth = idCardInfo.getString("date_of_birth");

        // Log the extracted data
        Log.d("IDCardInfo", "First Name: " + firstName);
        Log.d("IDCardInfo", "Last Name: " + lastName);
        Log.d("IDCardInfo", "Date of Birth: " + dateOfBirth);
    ...
    private void startCamera() {
        ...
        cameraProviderFuture.addListener(() -> {
            try {
                ...
                // Debugging: Log camera initialized
                Log.d("Camera", "Camera initialized successfully");

            } catch (Exception e) {
                Toast.makeText(this, "Camera initialization failed", Toast.LENGTH_SHORT).show();
                Log.e("CameraError", "Camera initialization failed: " + e.getMessage());
            }
